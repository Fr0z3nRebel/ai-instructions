...
description: Guidelines for creating high-quality Agent Skills. Use when creating or authoring agent skills, writing SKILL.md files, setting up .github/skills or .claude/skills, bundling scripts/references/templates, or when the user asks about skill structure, description best practices, progressive loading, or portable Copilot/Cursor skills.
---
...
The body contains detailed instructions that load AFTER the skill is activated. Recommended sections:
